...
# predictors show high collinearity (heatmap) especially between certain pairs
# model must choose how to distribute shared predictive power among correlated variables
# causes large shifts in coefficient size, changes in sign e.g. B1 switching from 34.73 -> -24.61
# and unstable or non-intuitive behaviour
# classic effect of multicolinearity
