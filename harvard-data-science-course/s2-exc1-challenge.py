...
ax.plot(range(1, maxdeg+1), training_error, label='Training Error', color='#FF7E79', alpha=0.4)

# Plot the validation error with labels
ax.plot(range(1, maxdeg+1), validation_error, label='Validation Error', color='#007D66', alpha=0.4)
